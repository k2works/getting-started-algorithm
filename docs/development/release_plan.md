...
- [x] Python プロジェクト初期化（apps/python/）
- [x] Wiki 記事の移行・再構成（9 章）
- [x] TDD 実装と記事の同期確認
- [x] mkdocs.yml に Python 記事を追加
...
- [x] Java プロジェクト初期化（apps/java/）
- [x] Python 版を基に Java 版 9 章を執筆
- [x] TDD 実装と記事の同期確認
- [x] ベロシティ検証・リリース計画再調整
...
- [x] .NET プロジェクト初期化（apps/csharp/）
- [x] Python 版を基に C# 版 9 章を執筆
- [x] TDD 実装と記事の同期確認
...
- [x] PHP プロジェクト初期化（apps/php/）
- [x] Python 版を基に PHP 版 9 章を執筆
- [x] TDD 実装と記事の同期確認（145 テスト全通過）
- [x] mkdocs.yml に PHP 記事を追加
...
- [x] Go プロジェクト初期化（apps/go/）
- [x] Python 版を基に Go 版 9 章を執筆
- [x] TDD 実装と記事の同期確認
- [x] mkdocs.yml に Go 記事を追加
...
29. イテレーション 11 計画の詳細作成（Scala 版）
30. Scala プロジェクト初期化（apps/scala/）
31. Python 版を基に Scala 版 9 章の執筆開始
