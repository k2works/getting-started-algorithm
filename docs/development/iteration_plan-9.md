...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 1-1 | Rust プロジェクト作成（apps/rust/、Cargo.toml 設定） | 20 分 | [ ] |
| 1-2 | ワークスペース構成（章ごとのモジュール分割） | 20 分 | [ ] |
| 1-3 | Nix devShell（.#rust）設定確認 | 20 分 | [ ] |

### 2. CI 整備（0.5 SP）

| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 2-1 | CI 設定（.github/workflows/ci-rust.yml: `cargo test`） | 20 分 | [ ] |
| 2-2 | CI 動作確認 | 10 分 | [ ] |
...
| 3-2 | 記事執筆（docs/article/rust/01-basic-algorithms.md） | 30 分 | [ ] |
...
| 4-2 | 記事執筆（docs/article/rust/02-arrays.md） | 20 分 | [ ] |
...
| 5-2 | 記事執筆（docs/article/rust/03-search-algorithms.md） | 20 分 | [ ] |
...
| 6-2 | 記事執筆（docs/article/rust/04-stacks-and-queues.md） | 20 分 | [ ] |
...
| 7-2 | 記事執筆（docs/article/rust/05-recursion.md） | 20 分 | [ ] |
...
| 8-2 | 記事執筆（docs/article/rust/06-sort-algorithms.md） | 20 分 | [ ] |
...
| 9-2 | 記事執筆（docs/article/rust/07-strings.md） | 20 分 | [ ] |
...
| 10-2 | 記事執筆（docs/article/rust/08-linked-lists.md） | 20 分 | [ ] |
...
| 11-2 | 記事執筆（docs/article/rust/09-trees.md） | 20 分 | [ ] |
