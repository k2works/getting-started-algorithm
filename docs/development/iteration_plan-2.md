...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 1.1 | `apps/node/` プロジェクト初期化（package.json, Jest, TypeScript 設定） | 1h | [ ] |
| 1.2 | `docs/article/node/index.md` 作成 | 0.5h | [ ] |
| 1.3 | mkdocs.yml に TypeScript セクション追加 | 0.5h | [ ] |
| 1.4 | Nix devShell `.#node` の動作確認 | 0.5h | [ ] |
...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 2.1 | 第 1 章 基本的なアルゴリズム — Python 版から変換・TDD 実装 | 1.5h | [ ] |
| 2.2 | 第 2 章 配列 — Python 版から変換・TDD 実装 | 1.5h | [ ] |
| 2.3 | 第 3 章 探索アルゴリズム — Python 版から変換・TDD 実装 | 1.5h | [ ] |
...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 3.1 | 第 4 章 スタックとキュー — Python 版から変換・TDD 実装 | 1.5h | [ ] |
| 3.2 | 第 5 章 再帰アルゴリズム — Python 版から変換・TDD 実装 | 1.5h | [ ] |
...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 4.1 | 第 6 章 ソートアルゴリズム — Python 版から変換・TDD 実装 | 2h | [ ] |
| 4.2 | 第 7 章 文字列処理 — Python 版から変換・TDD 実装 | 1.5h | [ ] |
...
| # | タスク | 見積もり | 状態 |
|---|--------|---------|------|
| 5.1 | 第 8 章 リスト — Python 版から変換・TDD 実装 | 2h | [ ] |
| 5.2 | 第 9 章 木構造 — Python 版から変換・TDD 実装 | 2h | [ ] |
...
| 第 1 部: 基本 | 1.0 | 4.5h | [ ] |
| 第 2 部: データ構造 | 0.5 | 3h | [ ] |
| 第 3 部: ソートと文字列 | 0.5 | 3.5h | [ ] |
| 第 4 部: 高度なデータ構造 | 0.5 | 4h | [ ] |
| **合計** | **3.0** | **17.5h** | |
